...
async function setupDatabase() {
  try {
    ...
    // Create tables for Daswos AI
    await client.query(`
      CREATE TABLE IF NOT EXISTS daswos_ai_chat (
        id SERIAL PRIMARY KEY,
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS daswos_ai_chat_message (
        id SERIAL PRIMARY KEY,
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS daswos_ai_source (
        id SERIAL PRIMARY KEY,
