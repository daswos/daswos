          ...
          <div className="w-full max-w-lg mb-6">
            {isAskingIfShopping ? (
              <div className="text-center">
                <div className="bg-blue-700 text-white border border-blue-800 rounded-lg p-4 mb-4">
                  <h3 className="text-lg font-medium mb-2 text-center">Are you shopping?</h3>
                  <p className="text-center mb-4">You searched for: <strong>{currentQuery}</strong></p>
