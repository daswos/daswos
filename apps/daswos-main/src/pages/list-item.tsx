...
const ListItemPage: React.FC = () => {
  ...
  const listItemMutation = useMutation({
    ...
    onSuccess: (response) => {
      // Check if approval is required based on server response
      const approvalRequired = response.approvalRequired !== false;

      toast({
        title: approvalRequired ? 'Item Submitted for Review' : 'Item Listed Successfully',
        description: response.message || (approvalRequired
          ? 'Your item has been submitted and is pending approval by an admin.'
          : 'Your item has been listed and is now available for buyers.'),
      });
      ...
      <Card className="max-w-2xl mx-auto">
        ...
        <CardContent>
          <Alert className="mb-4 border-blue-500 bg-blue-50">
            ...
            <AlertTitle className="text-blue-800">Product Approval Process</AlertTitle>
            <AlertDescription className="text-blue-700">
              All new listings require admin approval before they appear in the marketplace.
              You can check the status of your listings in the "My Listings" section.
              Approved items will be visible to buyers immediately.
            </AlertDescription>
          </Alert>
          ...
          {!user?.isSeller && (
            <Alert className="mb-4 border-amber-500 bg-amber-50">
              ...
              <AlertDescription className="text-amber-700">
                Becoming a trusted seller will increase your trust score and help you sell items faster.
                Complete the seller verification process to earn trust points and get your items approved more quickly.
              </AlertDescription>
            </Alert>
          )}
        </CardContent>
