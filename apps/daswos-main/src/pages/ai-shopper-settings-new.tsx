  ...
  return (
    <div className="container py-6 max-w-5xl">
      <div className="flex flex-col md:flex-row items-start justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">AI Shopper Settings</h1>
          <p className="text-muted-foreground mt-2">
            Configure your AI Shopper and manage your DasWos Coins
          </p>
        </div>
        ...
        <div className="flex items-center mt-4 md:mt-0">
          <div className="flex items-center space-x-2 mr-4">
            ...
            />
            <Label>{form.getValues("enabled") ? "Enabled" : "Disabled"}</Label>
          </div>
        </div>
      </div>
      ...
      <Tabs defaultValue="settings" value={selectedTab} onValueChange={setSelectedTab} className="w-full">
        <TabsList className="grid grid-cols-2 w-full mb-6">
          <TabsTrigger value="settings">AI Shopper Settings</TabsTrigger>
        ...
        <TabsContent value="settings" className="space-y-6">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle>AI Shopper Settings</CardTitle>
                  <CardDescription>
                    Configure how the AI Shopper will find and recommend products for you
                  </CardDescription>
                </CardHeader>
